...
| 소형 SMD 실제 데이터 | trusted registry 승인 canonical dataset 0장 | **NOT VERIFIED** | provenance·specimen ID가 있는 승인 실사 확보 |
| 안전한 반입 | dataset allowlist·STM32 specimen·ZIP resource limit·atomic ignored-data 출력 | **CODE PASS** | 실제 archive 반입 감사 |
| 오토라벨 | trusted locked split/exact image/teacher/calibration binding과 filtered 승격 | **CODE PASS / DATA BLOCKED** | 승인 registry entry·실제 teacher·CVAT export |
